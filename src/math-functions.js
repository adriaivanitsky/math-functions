...
export function multiply(a, b) {
    const product = a * b;
    const str = `The product of ${a} and ${b} is ${a * b}.`;
    return [product, str];
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const totalSum = sum(abSum, c)[0];
    const abProduct = multiply(a, b)[0];
    const totalProduct = multiply(abProduct, c)[0];
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const b = multArr[1];
    const c = multArr[2];
    const abmult = multiply(a, b)[0];
    const multArray = multiply(abmult, c)[0];
    const str = `The numbers ${a},${b},${c} have a product of ${multArray}.`;
    return [multArray, str]; 
...
and returns an array whose first element is the product of those numbers, and the second element is a string 
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for(let num of dynamicArray){
        product = multiply(num, product)[0];
